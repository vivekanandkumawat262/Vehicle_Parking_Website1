<template>
  <div v-if="token">
    ...
    <div v-if="role === 'user'">
      ...
      >
        <div>
          ...
          <span class="ms-3"
            ...
            <RouterLink to="/user/summary" class="mx-2">Summary</RouterLink>|
            ...
            <tbody>
              <tr v-for="h in userData.history" :key="h.id">
                ...
                <td class="text-center">
                  ...
                  <button v-else class="btn btn-secondary btn-sm px-3" disabled>
                    Completed
                  </button>
                </td>
              </tr>
      ...
      <div class="text-center mb-3">
        <span class="text-danger fw-bold me-3"
          >Search parking @ location/pin code:</span
        >
        <input
          type="text"
    ...
    >
      <div
        class="header d-flex justify-content-between align-items-center p-3 bg-light rounded"
      >
  ...
  <div v-else>
    <h1>
      Please <RouterLink to="/login">Login</RouterLink> to access the dashboard.
    </h1>
  </div>
</template>
